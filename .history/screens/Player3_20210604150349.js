      ...
      <View style={{ flex: 1, backgroundColor: "black" }}>
        ...
        <View style={{ marginVertical: 15, alignItems: "center" }}>
          ...
          <View style={{ alignItems: "center", marginTop: 15 }}>
            <Text style={{...style.nameText}} numberOfLines={2} ellipsizeMode="tail" >{data[currentindex].name}</Text>
        ...
        <>
          ...
          <View style={style.bottomView}>
            ...
            >
              <Ionicons
                size={32}
                style={{color:this.state.currentindex != data.length - 1?'white':'grey'}}
                name="md-fastforward"
              ></Ionicons>
            </TouchableOpacity>
          </View>
