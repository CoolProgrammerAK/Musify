...
class library extends Component {
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            this.refresh();
            this.setState({ opacity: 1,msg:"Playlist deleted successfully" });
            setTimeout(() => {
              this.setState({ opacity: 0 ,msg:""});
            }, 2000);
          },
        },
      ]
  ...
  postdata = async () => {
    if (this.state.text) {
      ...
      this.refresh();
      this.setState({ opacity: 1,msg:"Playlist created successfully" });
      setTimeout(() => {
        this.setState({ opacity: 0 ,msg:""});
      }, 2000);
