...
import { adddata } from "../reducer/action";import { StackActions } from "@react-navigation/native";
...
class Player2 extends Component {
  ...
  //      if(this.state.track !=this.props.route.params.track){
  //        this.loadAudio()
  ...
  //     if(prev.route.params.track ==this.props.route.params.track){
  //       this.loadAudio()
  ...
  async loadAudio() {
    const { currentindex, isBuffering, volume, playing } = this.state;
      ...
      <View style={{ flex: 1, backgroundColor: "black" }}>
        ...
        >
          ...
          {!show && (
            <SimpleLineIcons
              onPress={() => {
                this.props.navigation.dispatch(StackActions.push('add_playlist',{
                ...
                // this.props.navigation.navigate("add_playlist", {
                //   name: data[currentindex].name,
                //   photo: data[currentindex].photo,
                //   subname: data[currentindex].subtitle,
                //   id: data[currentindex].id,
        ...
        <View style={{ marginVertical: 15, alignItems: "center" }}>
          ...
          <View style={{ alignItems: "center", marginTop: 15 }}>
            ...
            <Text
              style={{ color: "orange", fontSize: 15, textAlign: "center" }}
            >
       ...
       <>
         <View style={{ width: 350, marginRight: "11%", marginLeft: 9 }}>
         <Slider
       ...
       <View
        ...
        >
          ...
          >
            <Ionicons
              size={32}
              style={{ color: this.state.currentindex != 0 ? "white" : "grey" }}
              name="md-rewind"
            ></Ionicons>
          </TouchableOpacity>
